        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdAlunoTurma = table.Column<Guid>(nullable: false),
                    IdObjetivo = table.Column<Guid>(nullable: false),
                    RankingIdRanking = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRanking = table.Column<Guid>(nullable: false),
                    Posicao = table.Column<int>(nullable: false),
                    IdObjetivoAluno = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rankings", x => x.IdRanking);
                    table.ForeignKey(
                        name: "FK_Rankings_ObjetivosAlunos_IdObjetivoAluno",
                        column: x => x.IdObjetivoAluno,
                        principalTable: "ObjetivosAlunos",
                        principalColumn: "IdObjetivoAluno",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjetivosAlunos_RankingIdRanking",
                table: "ObjetivosAlunos",
                column: "RankingIdRanking");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rankings_IdObjetivoAluno",
                table: "Rankings",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ObjetivosAlunos_Rankings_RankingIdRanking",
                table: "ObjetivosAlunos",
                column: "RankingIdRanking",
