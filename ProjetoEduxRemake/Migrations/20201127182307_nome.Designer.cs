...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoEduxRemake.Domains.ObjetivoAluno", b =>
                {
                    ...
                    b.Property<Guid?>("RankingIdRanking")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjetoEduxRemake.Domains.Ranking", b =>
                {
                    b.Property<Guid>("IdRanking")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjetoEduxRemake.Domains.ObjetivoAluno", b =>
                {
                    ...
                    b.HasOne("ProjetoEduxRemake.Domains.Ranking", null)
                        .WithMany("ObjetivosAlunos")
                        .HasForeignKey("RankingIdRanking");
                });
            ...
            modelBuilder.Entity("ProjetoEduxRemake.Domains.Ranking", b =>
                {
                    b.HasOne("ProjetoEduxRemake.Domains.ObjetivoAluno", "ObjetivoAluno")
                        .WithMany()
                        .HasForeignKey("IdObjetivoAluno")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
